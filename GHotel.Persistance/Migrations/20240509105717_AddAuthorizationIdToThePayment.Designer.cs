...
namespace GHotel.Persistance.Migrations
{
    ...
    [Migration("20240509105717_AddAuthorizationIdToThePayment")]
    partial class AddAuthorizationIdToThePayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyRoleMyUser", b =>
                {
            ...
            modelBuilder.Entity("GHotel.Domain.Entities.MyRole", b =>
                {
                    b.HasBaseType("GHotel.Domain.Entities.Entity");
            ...
            modelBuilder.Entity("MyRoleMyUser", b =>
                {
                    b.HasOne("GHotel.Domain.Entities.MyRole", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GHotel.Domain.Entities.MyUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GHotel.Domain.Entities.MyRole", b =>
                {
                    b.HasOne("GHotel.Domain.Entities.Entity", null)
                        .WithOne()
                        .HasForeignKey("GHotel.Domain.Entities.MyRole", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
